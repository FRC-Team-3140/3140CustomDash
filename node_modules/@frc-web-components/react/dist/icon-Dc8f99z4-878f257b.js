import { U as h, M as r, H as u, O as g } from "./property-C4BPH-wS-7fb0a59c.js";
const s = {
...
var d = Object.defineProperty, n = (t, o, l, v) => {
  for (var e = void 0, c = t.length - 1, p; c >= 0; c--)
    (p = t[c]) && (e = p(o, l, e) || e);
  return e && d(o, l, e), e;
};
`${Object.keys(s)[0]}`, Object.keys(s)[0];
const a = class extends u {
  constructor() {
    super(...arguments), this.color = "#000000", this.icon = "", this.svgPath = "", this.viewBox = "0 0 24 24";
  }
  render() {
    const o = this.icon === "Custom" || !this.icon;
    return g`
      <svg
        xmlns="http://www.w3.org/2000/svg"
        height="24px"
        viewBox=${o ? this.viewBox : "0 0 24 24"}
        width="24px"
        fill=${this.color}
      >
        <path d=${o ? this.svgPath : s[this.icon]} />
      </svg>
    `;
  }
};
...
customElements.get("frc-icon") || customElements.define("frc-icon", i);
export {
  i as t
};
